...
Locked project decisions. Where any other document or plan is ambiguous, this file
wins. Changes here require explicit maintainer sign-off; record the date.

## Decisions — 2026-06-12

| # | Decision | Locked value |
|---|----------|--------------|
| D0 | Name | **simloom** (PyPI free, no significant GitHub collisions as of 2026-06-12). |
...
| D9 | Visibility | Private during initial development; public at launch readiness. |

## Engineering discipline

- Quality bar: no cut corners. Strict typing on `src/`, ruff clean, hermetic offline
  tests, warnings-as-errors.
- The harness's own determinism claim is CI-enforced (the seed-torture job); any
  nondeterminism inside simloom is a release blocker by definition.
- Canonical plan lives in `docs/plan.md`; per-phase progress notes are updated in
  place, with validation gates between phases.
